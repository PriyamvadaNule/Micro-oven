...
void set_time(unsigned char key, int reset_flag)
{
    ...
    clcd_ch(min/10 + '0', (0xC0 + 7));
    clcd_ch(min%10 + '0', (0xC0 + 8));

    clcd_ch(':', (0xC0 + 9));


    clcd_ch(sec/10 + '0', (0xC0 + 10));
    clcd_ch(sec%10 + '0', (0xC0 + 11));
    }
...
void time_screen(void)
{
    ...
    clcd_ch(min/10 + '0', (0x80 + 8));
    clcd_ch(min%10 + '0', (0x80 + 9));

    clcd_ch(':', (0x80 + 10));


    clcd_ch(sec/10 + '0', (0x80 + 11));
    clcd_ch(sec%10 + '0', (0x80 + 12));
...
void set_temp(unsigned char key, int reset_flag)
{
        ...
        if(key == '#')
    {
        ...
        while(sec != 0)
        {
        clcd_ch((sec/100) + '0',(0x90 + 12));
        clcd_ch((sec/10)%10 + '0',(0x90 + 13));
        clcd_ch((sec%10) + '0',(0x90 + 14));
        }
    ...
    if(wait++ == 20)
    {
        ...
        clcd_ch((temp/100) + '0',(0xC0 + 8));
        clcd_ch(((temp/10)%10) + '0',(0xC0 + 9));
        clcd_ch( (temp%10) + '0',(0xC0 + 10));
